        ...
        <div className="grid md:grid-cols-3 gap-8 lg:-mt-8 pb-40">
          ...
          >
            <div className="relative overflow-hidden">
              <img
                src="/assets/images/projects/britishmuseum/britishmuseum_banner_md.jpg"
                alt="portfolio"
          ...
          >
            <div className="relative overflow-hidden">
              ...
              <img
                src="/assets/images/projects/ella/ella_banner_md.jpg"
                alt="portfolio"
                className="transform hover:scale-125 transition duration-2000 ease-out"
              />
              <h2 className="absolute top-10 left-10 text-gray-50 font-bold text-xl bg-red-500 rounded-md px-2">
          ...
          >
            <div className="relative overflow-hidden shadow-2xl">
              {/* <div className="overlay absolute inset-0 bg-black bg-opacity-70 z-10"></div> */}
              <img
                src="/assets/images/projects/rindle/rindle_banner_md.jpg"
                alt="portfolio"
