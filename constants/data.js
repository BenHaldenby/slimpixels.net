const userData = {
  githubUsername: 'benhaldenby',
  name: 'Ben Haldenby',
  designation: 'Frontend Developer',
  avatarUrl: '/avatar.png',
  email: 'benhaldenby@gmail.com',
  phone: '',
  address: 'Newport, Isle of Wight, UK',
  projects: [
    {
      title: 'British Museum',
      link: '/projects/british-museum/',
      imgUrl:
        '/assets/images/projects/britishmuseum/britishmuseum_banner_md.jpg',
    },
    {
      title: 'Ella',
      link: '/projects/ella/',
      imgUrl: '/assets/images/projects/ella/ella_banner_md.jpg',
    },
    {
      title: 'Rindle',
      link: '/projects/rindle/',
      imgUrl: '/assets/images/projects/rindle/rindle_banner_md.jpg',
    },
  ],
  about: {
    title:
    ...
    description: [
      ...
      `But now, I'm a legend. I've been coding in React, Angular, Vue, Svelte, Node.js, Express, Fastify, MongoDB, MySQL, Bootstrap, TailwindTailwind, C, C++, C#, Rust, Haskell, Perl, PHP, Assembly, Logo and YouDontKnowShit programming language etc to name a few. Although I barely know the syntax (Psst, Stack overflow!), I consider myself a Ninja developer I'm laughing right now.`,
    ],
